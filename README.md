...
2.	Dynamic UI Generation: Built buildLangButtons() to programmatically create language selection buttons from the data structure
3.	State Management: Implemented selectLanguage() to handle language switching with visual feedback
...
Technical Context: These coefficients derive from the ITU-R BT.601 standard for converting RGB to grayscale in video systems. They represent the relative luminous efficiency function of human photopic vision.
Practical Impact:
